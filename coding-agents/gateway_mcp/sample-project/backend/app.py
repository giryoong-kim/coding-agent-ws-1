...
def list_tasks():
    ...
    if status:
        # BUG: comparison is case-sensitive, so "Done" vs "done" won't match
...
def update_task(task_id):
    ...
    # BUG: allows setting status to any arbitrary string, with no validation
    if "title" in data:
...
def delete_task(task_id):
    ...
    # BUG: filter logic is inverted, keeping the task and removing everything else
